...
module.exports = function(options, grunt) {
    ...
    function getFiles(dir,files_, isCss ){
        files_ = files_ || [];
        ...
        for(var i in files){
            ...
            if (  des[des.length-1] == "DS_Store" ) continue;
            if ( isCss && des[des.length-1] != 'css' && des[des.length-1] != 'less' ) continue;
    ...
    function getCssFiles(){
        return getFiles(paths.app + "/less",undefined,true).map(function(file){
