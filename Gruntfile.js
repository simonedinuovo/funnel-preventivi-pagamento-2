/**
 * @author  Simone Di Nuovo <simone_di_nuovo@yahoo.it>
...
module.exports = function(grunt) {
	...
	grunt.registerTask("cloneGit", ["shell:gitclone"]);
	grunt.registerTask('update', ["clean:coreApp","shell:gitclone","copy:core","clean:core"]);
};
